...
const embed = new Discord.MessageEmbed()
   .setAuthor('Annke™ -2.0.0A', 'https://images-ext-2.discordapp.net/external/AF4HkhT5ipvq7wNll6GkfRqbt6HY0Q4nrjxO9mjDRF8/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/778636554386145331/adb03a20a79a238980dd396c4218ed12.webp?width=395&height=395')
   .setColor('#63a7ff')
    ...
    .addField("**:dizzy:➤  Comandos Úteis**", "**``/anuncio`` ``/enquete`` ``/sorteio`` ``/lock`` ``/unlock`` ``/slowmode`` ``/criar_canal`` ``/clear`` ``info`` ** ``ping`` **``")
